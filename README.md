...
- Web &ldquo;[fonts](https://brycewray.com/posts/2018/10/web-typography-part-2/)&rdquo;&mdash;The [Public Sans](https://public-sans.digital.gov) for all non-code text and [Roboto Mono](https://fonts.google.com/specimen/Roboto+Mono) for code and code blocks. I formerly &ldquo;self&rdquo;-hosted them but, after reading [this article](https://www.tunetheweb.com/blog/should-you-self-host-google-fonts/), decided to go with the [online versions](https://fonts.google.com).
