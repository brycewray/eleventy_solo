...
- [lazysizes](https://github.com/aFarkas/lazysizes) (with its [`blur-up` plugin](https://github.com/aFarkas/lazysizes/tree/gh-pages/plugins/blur-up)) and `eleventy-plugin-local-respimg` for processing the few images on the site.
