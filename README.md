...
- [lazysizes](https://github.com/aFarkas/lazysizes) and [eleventy-plugin-local-respimg](https://www.npmjs.com/package/eleventy-plugin-local-respimg) for processing the few images on the site.
