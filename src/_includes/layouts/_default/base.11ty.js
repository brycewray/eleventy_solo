...
<html lang="en" class="font-body dark:bg-black">
  ...
  <body>
    ...
    <header class="h-12 bg-blue-700 w-full fixed p-0 mt-0 z-50">
      <p class="text-white font-bold mt-2 pt-1 text-lg ml-4 md:ml-8 lg:ml-16"><a href="/" class="text-white active:text-gray-400 hover:text-gray-400" style="border: 0 !important; text-decoration: none !important;">BryceWray.com</a></p>
    ...
    <footer class="text-center pb-6">
      <div class="w-5/6 md:w-3/4 lg:w-2/3 mx-auto">
        ...
        <p class="text-xs mt-4 mb-4"><a href="https://github.com/brycewray/eleventy_solo" target="_blank" rel="noopener">This site&rsquo;s GitHub repository</a><br /><a href="https://twitter.com/BryceWrayTX" target="_blank" rel="noopener">My Twitter account</a><br /><a href="https://www.linkedin.com/in/brycewray" target="_blank" rel="noopener">My LinkedIn account</a><br /><a href="/feed.xml">This site&rsquo;s RSS feed</a></p>
      </div>
      <!-- for webmentions -->
