  ...
  <body>
    ...
    <footer class="text-center pb-6">
      <div class="w-5/6 md:w-3/4 lg:w-2/3 mx-auto">
        <p class="text-xs inline-flex mt-4 mb-4"><a href="https://github.com/brycewray/eleventy_solo" target="_blank" rel="noopener" class="mb-0 border-transparent"><img src="/images/icons/GitHub_octocat_logo_blue_96x96.png" class="lazy" style="height: 48px; width: 48px;" alt="GitHub logo"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://twitter.com/BryceWrayTX" target="_blank" rel="noopener" class="mb-0 border-transparent"><img src="/images/icons/twitter-2430933_circle_96x96.png" class="lazy" style="height: 48px; width: 48px;" alt="Twitter logo"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://www.linkedin.com/in/brycewray" target="_blank" rel="noopener" class="mb-0 border-transparent"><img src="/images/icons/linked-in-2674741_circle_96x96.png" class="lazy" style="height: 48px; width: 48px;" alt="LinkedIn logo"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/feed.xml" class="mb-0 border-transparent"><img src="/images/icons/rss-2440955_circle_96x96.png" class="lazy" style="height: 48px; width:48px;" alt="RSS logo"></a></p>
        <p class="text-xs">
