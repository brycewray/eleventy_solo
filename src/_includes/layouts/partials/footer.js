    ...
    <footer class="text-center pb-6">
      <div class="w-5/6 md:w-3/4 lg:w-2/3 mx-auto">
        ...
        <p class="text-xs">
          ...
          Site built and managed with <a href="https://jamstack.org" target="_blank" rel="noopener">the Jamstack</a>, <a href="https://11ty.dev" target="_blank" rel="noopener">Eleventy</a>, <a href="https://tailwindcss.com/" target="_blank" rel="noopener">Tailwind CSS</a>, <a href="https://www.apple.com/macos" target="_blank" rel="noopener">macOS</a>, <a href="https://www.apple.com/ios" target="_blank" rel="noopener">iOS</a>, <a href="https://daringfireball.net/projects/markdown" target="_blank" rel="noopener">Markdown</a>, <span class="text-nowrap">time, and&nbsp;love.</span> <span class="text-nowrap">Site hosted by <a href="https://vercel.com" target="_blank" rel="noopener">Vercel</a></span>. <span class="text-nowrap">Images hosted and processed by <a href="https://cloudinary.com" target="_blank" rel="noopener">Cloudinary</a>.</span> This&nbsp;site <strong>does&nbsp;not</strong>&nbsp;track your&nbsp;personal&nbsp;data, thanks&nbsp;to <a href="${affilLink}" target="_blank" rel="noopener">Fathom&nbsp;Analytics</a>. <span class="text-nowrap"><em>UTC</em> &equals; <a href="https://en.wikipedia.org/wiki/Coordinated_Universal_Time" target="_blank" rel="noopener">Coordinated Universal Time</a>.</span>
        </p>
      </div>
      <!-- for webmentions -->
