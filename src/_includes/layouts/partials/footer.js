...
module.exports = function(eleventyConfig) {
  ...
  <footer class="ctr">
    <p><a href="https://github.com/brycewray/eleventy_bundler" target="_blank" rel="noopener" style="border-bottom: none;"><img src="/images/GitHub_octocat_logo_blue_48x48.png" style="height: 24px; width: 24px;" alt="GitHub"></a>&nbsp;&nbsp;<a href="https://twitter.com/BryceWrayTX" target="_blank" rel="noopener" style="border-bottom: none;"><img src="/images/twitter-2430933_48x48.png" style="height: 24px; width: 24px;" alt="Twitter"></a>&nbsp;&nbsp;<a href="https://www.linkedin.com/in/brycewray" target="_blank" rel="noopener" style="border-bottom: none;"><img src="/images/linked-in-2674741_48x48.png" style="height: 24px; width: 24px;" alt="LinkedIn"></a>&nbsp;&nbsp;<a href="/feed.xml" style="border-bottom: none;"><img src="/images/rss-2440955_48x48.png" style="height: 24px; width:24px;" alt="RSS"></a></p>
    <p class="legaltxt">
    ...
    <img class="u-photo" alt="This site's 'BW' logo" src="/images/favicon-512x512.png" style="width: 45px; height: 45px;" />
