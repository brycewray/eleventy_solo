...
module.exports = function(eleventyConfig) {
  ...
  <footer class="text-center pb-6">
    ...
    <div class="w-full mx-auto">
      <h4 class="not-italic text-sm mt-4 mb-2">Information for webmentions</h4>
      <p class="inline-flex"><img class="u-photo" alt="This site's 'BW' logo" src="/images/icons/favicon-512x512.png" style="width: 45px; height: 45px;" /></p>
      <p class="p-note text-xs tracking-normal leading-tight">Unrepentant advocate for and user of the Oxford comma (sorry,&nbsp;AP). Webmentions&nbsp;of others&rsquo; content do&nbsp;not necessarily constitute endorsements. Comments&nbsp;and opinions expressed herein are my&nbsp;own, unless otherwise&nbsp;noted.</p>
      ${data.title !="Posts"
