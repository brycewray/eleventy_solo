...
{% respimg "Outlook_full_img_600x940.jpg", "Fancy email from ad agency with styled text and artwork", 600, 940 %}

. . . this is what actually gets through the desktop version of Outlook:

{% respimg "Outlook_full_no_imgs_600x940.jpg", "Email with many blank spaces because email client blocks images", 600, 940 %}
