...
{% lazypicture "Outlook_full_img.jpg", "Fancy email from ad agency with styled text and artwork" %}

. . . this is what actually gets through the desktop version of Outlook:

{% lazypicture "Outlook_full_no_imgs.jpg", "Email with many blank spaces because email client blocks images" %}
