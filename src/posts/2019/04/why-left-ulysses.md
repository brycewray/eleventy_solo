...
<p class="text-sm text-center leading-5">Ulysses’s Quick Export feature: the only way you can derive a true, standalone, visible Markdown&nbsp;file from one of its native, proprietary-format&nbsp;files.</p>
...
<p class="text-sm text-center leading-5">When this little cloud icon (highlighted in the yellow circle) just sits and sits and sits in the Ulysses sheet synopsis and the timestamp doesn&rsquo;t change, even though you edited this file days ago on another device—Houston, we have an iCloud&nbsp;sync&nbsp;problem.</p>
...
<p class="text-sm text-center leading-5">Ladies and gentlemen, the winner (for now): iA&nbsp;Writer.</p>
