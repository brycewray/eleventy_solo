...
{% lazypicture "Working_Copy_scr_cap_01.png", "iPad screen capture: Working Copy on the left, iA Writer on the right" %}
...
{% lazypicture "Working_Copy_scr_cap_02.png", "iPad screen capture: Working Copy display of the local Git repository on the device" %}
...
{% lazypicture "Working_Copy_scr_cap_04.png", "iPad screen capture: Working Copy display showing a push has gone to Bitbucket" %}
...
{% lazypicture "Working_Copy_scr_cap_07.png", "iPad screen capture: Working Copy display showing that the master branch is synchronized with the three remote repositories" %}
...
{% lazypicture "Working_Copy_scr_cap_11.png", "iPad screen capture: Working Copy display showing its built-in text editor" %}
