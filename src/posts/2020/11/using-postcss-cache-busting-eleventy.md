...
**Important note, 2020-12-07**: If you previously read this, please note the **additional information** (also yellow-boxed) I added today in the instructions.{.yellowBox}
...
**Additional step, 2020-12-07**: Be sure to put the `postcss-hash` part **last** in your `plugins` array, as shown here; otherwise, it won't work as described herein.{.yellowBox}
