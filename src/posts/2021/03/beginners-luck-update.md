...
- ***[eleventy_solo_starter_twjit](https://github.com/brycewray/eleventy_solo_starter_twjit)**---As of 2021-04-05, no longer in active development, because the addition of the JIT compiler to Tailwind CSS core as of Tailwind 2.1.0 makes it duplicative of the [eleventy_solo_starter](https://github.com/brycewray/eleventy_solo_starter) repo.*
- ***[eleventy_solo_starter_njk_twjit](https://github.com/brycewray/eleventy_solo_starter_njk_twjit)**---As of 2021-04-05, no longer in active development, because the addition of the JIT compiler to Tailwind CSS core as of Tailwind 2.1.0 makes it duplicative of the [eleventy_solo_starter_njk](https://github.com/brycewray/eleventy_solo_starter_njk) repo.*
